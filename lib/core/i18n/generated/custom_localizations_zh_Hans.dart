...
/// The translations for Chinese (Simplified) (`zh_Hans`).
class CustomLocalizationZhHans extends CustomLocalizations {
  CustomLocalizationZhHans([String locale = 'zh_Hans']) : super(locale);
