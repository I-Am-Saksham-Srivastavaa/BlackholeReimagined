...
class CustomLocalizationEl extends CustomLocalizations {
  CustomLocalizationEl([String locale = 'el']) : super(locale);
  ...
  @override
  String get aboutLine2 => 'Αν σου άρεσε η δουλειά μου δείξε ♥ και ⭐ το repo';
