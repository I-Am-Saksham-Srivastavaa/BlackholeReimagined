...
/// The translations for Persian (PAL) (`fa_PAL`).
class CustomLocalizationFaPAL extends CustomLocalizations {
  CustomLocalizationFaPAL([String locale = 'fa_PAL']) : super(locale);
  ...
  @override
  String get aboutLine2 => 'اگر کار من را دوست دارید ♥  کنید و مخزن را ⭐  کنید';
