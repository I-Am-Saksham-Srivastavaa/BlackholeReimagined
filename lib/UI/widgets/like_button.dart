  ...
  Widget build(BuildContext context) {
    ...
    return ScaleTransition(
      ...
      child: IconButton(
        ...
        tooltip: liked
            ? CustomLocalizations.of(context).unlike
            : CustomLocalizations.of(context).like,
        onPressed: () async {
          liked
              ? removeLiked(
          ...
          if (widget.showSnack) {
            ShowSnackBar().showSnackBar(
              context,
              liked
                  ? CustomLocalizations.of(context).addedToFav
                  : CustomLocalizations.of(context).removedFromFav,
              action: SnackBarAction(
                textColor: Theme.of(context).colorScheme.secondary,
                label: CustomLocalizations.of(context).undo,
                onPressed: () {
                  liked
                      ? removeLiked(
                          widget.mediaItem == null
