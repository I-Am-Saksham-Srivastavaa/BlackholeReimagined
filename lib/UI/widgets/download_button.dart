      ...
      child: Center(
        child: (down.lastDownloadId == widget.data.last['id'])
            ? IconButton(
                ...
                color: Theme.of(context).colorScheme.secondary,
                iconSize: 25.0,
                tooltip: CustomLocalizations.of(context).downDone,
                onPressed: () {},
              )
            : down.progress == 0
                ? Center(
                    child: IconButton(
                      ...
                      iconSize: 25.0,
                      tooltip: CustomLocalizations.of(context).down,
                      onPressed: () async {
                    ...
                    child: IconButton(
                      ...
                      onPressed: () async {
                        ShowSnackBar().showSnackBar(
                          context,
                          '${CustomLocalizations.of(context).downingAlbum} "${widget.albumName}"',
                        );
