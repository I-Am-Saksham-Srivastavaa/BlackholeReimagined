...
// import 'package:oryn/Helpers/countrycodes.dart';
        ...
        appBar: AppBar(
          ...
          bottom: TabBar(
            ...
            tabs: [
              Tab(
                child: Text(
                  CustomLocalizations.of(context).local,
                  style: TextStyle(
              ...
              Tab(
                child: Text(
                  CustomLocalizations.of(context).global,
                  style: TextStyle(
                    color: Theme.of(context).textTheme.bodyLarge!.color,
                  ),
                ),
          ...
          title: Text(
            CustomLocalizations.of(context).spotifyCharts,
            style: TextStyle(
              fontSize: 18,
              color: Theme.of(context).textTheme.bodyLarge!.color,
            ),
              ...
              Expanded(
                child: Center(
                  child: TextButton(
                    ...
                    child: Text(CustomLocalizations.of(context).signInSpotify),
                  ),
                ),
              )
                          ...
                          PopupMenuItem(
                            ...
                            child: Row(
                              children: [
                                ...
                                Text(
                                  CustomLocalizations.of(context).openInSpotify,
                                ),
                              ],
                            ),
                          ),
