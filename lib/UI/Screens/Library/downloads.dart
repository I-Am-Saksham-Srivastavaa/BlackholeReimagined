    ...
    return GradientContainer(
      child: DefaultTabController(
        ...
        child: Scaffold(
          ...
          appBar: AppBar(
            title: Text(CustomLocalizations.of(context).downs),
            centerTitle: true,
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    Text(
                      CustomLocalizations.of(context).albumArtist,
                      style: TextStyle(
                        color: Theme.of(context).colorScheme.secondary,
                      ),
                    ),
                ...
                Row(
                  children: [
                    Text(
                      CustomLocalizations.of(context).genre,
                      style: TextStyle(
                        color: Theme.of(context).colorScheme.secondary,
                      ),
                    ),
                ...
                Row(
                  children: [
                    Text(
                      CustomLocalizations.of(context).year,
                      style: TextStyle(
                        color: Theme.of(context).colorScheme.secondary,
                      ),
                    ),
                ...
                Row(
                  children: [
                    Text(
                      CustomLocalizations.of(context).songPath,
                      style: TextStyle(
                        color: Theme.of(context).colorScheme.secondary,
                      ),
                    ),
            ...
            onPressed: () async {
              ...
              try {
                try {
                  ...
                  ShowSnackBar().showSnackBar(
                    context,
                    CustomLocalizations.of(context).successTagEdit,
                  );
                }
              } catch (e) {
                ...
                ShowSnackBar().showSnackBar(
                  context,
                  '${CustomLocalizations.of(context).failedTagEdit}\nError: $e',
                );
              }
            },
            child: Text(
              CustomLocalizations.of(context).ok,
              style: TextStyle(
