...
class _PlaylistScreenState extends State<PlaylistScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return GradientContainer(
      child: Scaffold(
        ...
        appBar: AppBar(
            title: Text(CustomLocalizations.of(context).playlists),
            centerTitle: true,
            elevation: 0,
            backgroundColor: Colors.transparent,
                          ...
                          onSelected: (int? value) async {
                            ...
                            if (value == 0) {
                              ShowSnackBar().showSnackBar(
                                context,
                                '${CustomLocalizations.of(context).deleted} $showName',
                              );
                              ...
                              PopupMenuItem(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Text(
                                      CustomLocalizations.of(context).rename,
                                    ),
                                  ],
                                ),
                              ),
                            ...
                            PopupMenuItem(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  const SizedBox(width: 10.0),
                                  Text(
                                    CustomLocalizations.of(context).export,
                                  ),
                                ],
                              ),
                            ),
                            PopupMenuItem(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  const SizedBox(width: 10.0),
                                  Text(
                                    CustomLocalizations.of(context).share,
                                  ),
                                ],
                              ),
                            ),
  ...
  List<Widget> _actions(BuildContext context) {
    return [
      ...
      IconButton(
        icon: const Icon(MdiIcons.import),
        onPressed: () {
          showBottomSheet(
              context: context,
              builder: (context) {
      ...
      IconButton(
        ...
        onPressed: () {
          showBottomSheet(
            context: context,
            builder: (BuildContext context) {
              return PlaylistMerging(context);
            },
          );
        },
      ),
  ...
  ListTile PlaylistMerging(BuildContext context) {
    return ListTile(
      title: Text(CustomLocalizations.of(context).mergePlaylists),
  ...
  // ignore: non_constant_identifier_names
  ListTile PlaylistImporting(BuildContext context) {
    return ListTile(
      title: Text(CustomLocalizations.of(context).importPlaylist),
      leading: SizedBox.square(
        dimension: 50,
        child: Center(
          child: Icon(
  ...
  ListTile playlistCreation(BuildContext context) {
    return ListTile(
