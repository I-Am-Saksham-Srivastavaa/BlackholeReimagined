import 'package:oryn/core/Helpers/songs_count.dart' as songs_count;
...
class FavouiteSongsTab extends StatefulWidget {
  ...
  @override
  State<FavouiteSongsTab> createState() => _FavouiteSongsTabState();
}

class _FavouiteSongsTabState extends State<FavouiteSongsTab>
  ...
  Widget build(BuildContext context) {
    ...
    return (widget.songs.isEmpty)
        ? emptyScreen(
            ...
            50,
            CustomLocalizations.of(context).addSomething,
            23.0,
          )
        : Column(
            children: [
...
class FavoriteAlbumTab extends StatefulWidget {
  ...
  @override
  State<FavoriteAlbumTab> createState() => _FavoriteAlbumTabState();
}

class _FavoriteAlbumTabState extends State<FavoriteAlbumTab>
    with AutomaticKeepAliveClientMixin {
  @override
  bool get wantKeepAlive => true;
              ...
              return ListTile(
                ...
                subtitle: Text(
                  widget.albums[widget.sortedAlbumKeysList[index]]!.length == 1
                      ? '${widget.albums[widget.sortedAlbumKeysList[index]]!.length} ${CustomLocalizations.of(context).song}'
                      : '${widget.albums[widget.sortedAlbumKeysList[index]]!.length} ${CustomLocalizations.of(context).songs}',
                  style: TextStyle(
