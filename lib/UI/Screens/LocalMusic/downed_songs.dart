  ...
  Future<void> deleteSong(SongModel song) async {
    ...
    try {
      ...
      ShowSnackBar().showSnackBar(
        context,
        '${CustomLocalizations.of(context).deleted} ${song.title}',
      );
    } catch (e) {
      ...
      ShowSnackBar().showSnackBar(
        ...
        '${CustomLocalizations.of(context).failedDelete}: ${audioFile.path}\nError: $e',
      );
    }
  }
          ...
          appBar: AppBar(
            ...
            bottom: TabBar(
              ...
              tabs: [
                ...
                Tab(
                  text: CustomLocalizations.of(context).folders,
                ),
                              ...
                              PopupMenuItem(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    const SizedBox(width: 10.0),
                                    Text(
                                        CustomLocalizations.of(context).remove),
                                  ],
                                ),
                              ),
                            // PopupMenuItem(
                            ...
                            PopupMenuItem(
                              ...
                              child: Row(
                                children: [
                                  const Icon(Icons.delete_rounded),
                                  const SizedBox(width: 10.0),
                                  Text(CustomLocalizations.of(context).delete),
                                ],
                              ),
                            ),
                          ],
