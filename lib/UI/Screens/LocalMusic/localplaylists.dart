            ...
            ListView.builder(
              ...
              itemBuilder: (context, index) {
                return ListTile(
                  ...
                  subtitle: Text(
                    '${playlistDetails[index].numOfSongs} ${CustomLocalizations.of(context).songs}',
                  ),
                  trailing: PopupMenuButton(
                    ...
                    onSelected: (int? value) async {
                      if (value == 0) {
                        if (await widget.offlineAudioQuery.removePlaylist(
                          ...
                          ShowSnackBar().showSnackBar(
                            context,
                            '${CustomLocalizations.of(context).deleted} ${playlistDetails[index].playlist}',
                          );
                          ...
                          ShowSnackBar().showSnackBar(
                            context,
                            CustomLocalizations.of(context).failedDelete,
                          );
                        }
                      }
                      // if (value == 3) {
                      ...
                      //       title: CustomLocalizations.of(context)!
                      //           .rename,
                      //       initialText:
                      //           playlistDetails[index].playlist,
